...
<!-- GENERATED from commands/resume.md by bin/build-codex-skills.py — do not edit here. -->
...
4. **Continue the workflow** from the first available task, following `.agents/skills/run/SKILL.md` from the matching phase. Re-apply the Phase 0 tier and gate policy that was recorded in the plan.
